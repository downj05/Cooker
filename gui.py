...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cookTimeLabelLayout.addItem(spacerItem1)
        self.cookTimeLabelTime = QtWidgets.QLineEdit(self.cookTimeFrame)
        ...
        self.cookTimeSlider.setMaximum(86400)
        ...
        self.experiments_tab = QtWidgets.QWidget()
        self.experiments_tab.setObjectName("experiments_tab")
        self.verticalLayout_13 = QtWidgets.QVBoxLayout(self.experiments_tab)
        self.verticalLayout_13.setObjectName("verticalLayout_13")
        self.joinEscapeKeyCheckboxGroup = QtWidgets.QGroupBox(self.experiments_tab)
        ...
        self.frame = QtWidgets.QFrame(self.experiments_tab)
        ...
        self.antiAfkMethodComboBox = QtWidgets.QComboBox(self.frame)
        self.antiAfkMethodComboBox.setObjectName("antiAfkMethodComboBox")
        self.antiAfkMethodComboBox.addItem("")
        self.antiAfkMethodComboBox.addItem("")
        self.antiAfkMethodComboBox.addItem("")
        self.antiAfkMethodComboBox.addItem("")
        self.horizontalLayout_8.addWidget(self.antiAfkMethodComboBox)
        self.verticalLayout_13.addWidget(self.frame)
        self.joinCommandBox = QtWidgets.QGroupBox(self.experiments_tab)
        ...
        self.periodicStatusCommandGroupCheckBox = QtWidgets.QGroupBox(self.experiments_tab)
        self.periodicStatusCommandGroupCheckBox.setCheckable(True)
        self.periodicStatusCommandGroupCheckBox.setObjectName("periodicStatusCommandGroupCheckBox")
        self.verticalLayout_11 = QtWidgets.QVBoxLayout(self.periodicStatusCommandGroupCheckBox)
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.periodicCommandTextField = QtWidgets.QLineEdit(self.periodicStatusCommandGroupCheckBox)
        ...
        self.verticalLayout_13.addWidget(self.periodicStatusCommandGroupCheckBox)
        self.loopCookCheckbox = QtWidgets.QGroupBox(self.experiments_tab)
        self.loopCookCheckbox.setCheckable(True)
        self.loopCookCheckbox.setObjectName("loopCookCheckbox")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.loopCookCheckbox)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.label_6 = QtWidgets.QLabel(self.loopCookCheckbox)
        self.label_6.setObjectName("label_6")
        self.verticalLayout_3.addWidget(self.label_6)
        self.loopSpinBox = QtWidgets.QSpinBox(self.loopCookCheckbox)
        self.loopSpinBox.setMaximum(9999999)
        self.loopSpinBox.setObjectName("loopSpinBox")
        self.verticalLayout_3.addWidget(self.loopSpinBox)
        self.verticalLayout_13.addWidget(self.loopCookCheckbox)
        self.extraSettingsTabWidget.addTab(self.experiments_tab, "")
        self.webhook_tab = QtWidgets.QWidget()
        self.webhook_tab.setObjectName("webhook_tab")
        self.verticalLayout_12 = QtWidgets.QVBoxLayout(self.webhook_tab)
        self.verticalLayout_12.setObjectName("verticalLayout_12")
        self.webhookEnabledCheckBox = QtWidgets.QCheckBox(self.webhook_tab)
        ...
        self.webhookUrlTextBox = QtWidgets.QLineEdit(self.webhook_tab)
        ...
        self.testWebhookButton = QtWidgets.QPushButton(self.webhook_tab)
        self.testWebhookButton.setObjectName("testWebhookButton")
        self.verticalLayout_12.addWidget(self.testWebhookButton)
        self.label_2 = QtWidgets.QLabel(self.webhook_tab)
        self.label_2.setObjectName("label_2")
        self.verticalLayout_12.addWidget(self.label_2)
        self.scrollArea = QtWidgets.QScrollArea(self.webhook_tab)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 272, 93))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.horizontalLayout_15 = QtWidgets.QHBoxLayout(self.scrollAreaWidgetContents)
        self.horizontalLayout_15.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_15.setSpacing(0)
        self.horizontalLayout_15.setObjectName("horizontalLayout_15")
        self.pingList = QtWidgets.QTextEdit(self.scrollAreaWidgetContents)
        self.pingList.setOverwriteMode(False)
        self.pingList.setObjectName("pingList")
        self.horizontalLayout_15.addWidget(self.pingList)
        self.scrollArea.setWidget(self.scrollAreaWidgetContents)
        self.verticalLayout_12.addWidget(self.scrollArea)
        self.webhookCriteria = QtWidgets.QGroupBox(self.webhook_tab)
        ...
        self.extraSettingsTabWidget.addTab(self.webhook_tab, "")
        self.info_tab = QtWidgets.QWidget()
        self.info_tab.setObjectName("info_tab")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.info_tab)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.frame_7 = QtWidgets.QFrame(self.info_tab)
        ...
        self.hostnameTxt = QtWidgets.QLineEdit(self.frame_2)
        self.hostnameTxt.setReadOnly(True)
        self.hostnameTxt.setObjectName("hostnameTxt")
        self.horizontalLayout_10.addWidget(self.hostnameTxt, 0, QtCore.Qt.AlignRight)
        ...
        self.cpuTxt = QtWidgets.QLineEdit(self.frame_3)
        self.cpuTxt.setReadOnly(True)
        self.cpuTxt.setObjectName("cpuTxt")
        self.horizontalLayout_11.addWidget(self.cpuTxt, 0, QtCore.Qt.AlignRight)
        ...
        self.ramTxt = QtWidgets.QLineEdit(self.frame_4)
        self.ramTxt.setReadOnly(True)
        self.ramTxt.setObjectName("ramTxt")
        self.horizontalLayout_12.addWidget(self.ramTxt, 0, QtCore.Qt.AlignRight)
        ...
        self.steam64Txt = QtWidgets.QLineEdit(self.frame_5)
        self.steam64Txt.setReadOnly(True)
        self.steam64Txt.setObjectName("steam64Txt")
        self.horizontalLayout_13.addWidget(self.steam64Txt, 0, QtCore.Qt.AlignRight)
        ...
        self.steamUsernameTxt = QtWidgets.QLineEdit(self.frame_6)
        self.steamUsernameTxt.setReadOnly(True)
        self.steamUsernameTxt.setObjectName("steamUsernameTxt")
        self.horizontalLayout_14.addWidget(self.steamUsernameTxt, 0, QtCore.Qt.AlignRight)
        ...
        self.extraSettingsTabWidget.addTab(self.info_tab, "")
        self.mainSettings.addWidget(self.extraSettingsTabWidget, 0, QtCore.Qt.AlignTop)
        ...
        self.extraSettingsTabWidget.setCurrentIndex(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "Anti-AFK Method:"))
        self.antiAfkMethodComboBox.setItemText(0, _translate("MainWindow", "None"))
        self.antiAfkMethodComboBox.setItemText(1, _translate("MainWindow", "Micro Movements (Most Subtle)"))
        self.antiAfkMethodComboBox.setItemText(2, _translate("MainWindow", "Random Walk (Somewhat Subtle)"))
        self.antiAfkMethodComboBox.setItemText(3, _translate("MainWindow", "Frank B Oogie (Least Subtle)"))
        ...
        self.periodicStatusCommandGroupCheckBox.setTitle(_translate("MainWindow", "Send Command/Message on Status Update"))
        self.periodicCommandTextField.setPlaceholderText(_translate("MainWindow", "e.g /pay w32 5000"))
        self.loopCookCheckbox.setTitle(_translate("MainWindow", "Loop Cook"))
        self.label_6.setText(_translate("MainWindow", "Inbetween Loop Wait Time (seconds):"))
        self.extraSettingsTabWidget.setTabText(self.extraSettingsTabWidget.indexOf(self.experiments_tab), _translate("MainWindow", "Experiments"))
        ...
        self.pingList.setPlaceholderText(_translate("MainWindow", "discord user ID\'s (one for each line)"))
        ...
        self.extraSettingsTabWidget.setTabText(self.extraSettingsTabWidget.indexOf(self.webhook_tab), _translate("MainWindow", "Webhook"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Device"))
        self.label_8.setText(_translate("MainWindow", "Hostname:"))
        self.label_9.setText(_translate("MainWindow", "CPU:"))
        self.label_10.setText(_translate("MainWindow", "RAM:"))
        self.groupBox_3.setTitle(_translate("MainWindow", "Steam Account"))
        self.label_11.setText(_translate("MainWindow", "Steam64:"))
        self.label_12.setText(_translate("MainWindow", "Username:"))
        self.extraSettingsTabWidget.setTabText(self.extraSettingsTabWidget.indexOf(self.info_tab), _translate("MainWindow", "Info"))
